...
Extracts cognitive and behavioral signals from the journal text using rule-based NLP.
...
Compares the current learning state with recent history.
Generates adaptive study strategies using deterministic rules.
Optionally uses AI only to explain the already-computed profile in simple educational language.
